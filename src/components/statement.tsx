  ...
  return (
    <Section index={index} label="About">
      <div className="flex flex-col gap-10 md:flex-row md:items-start md:justify-between md:gap-16">
        <h2 className="font-display font-medium uppercase text-[clamp(2.25rem,5.5vw,4.5rem)] leading-[0.95] tracking-[-0.03em] md:max-w-[62%]">
          Building modern web
          <br />
        ...
        <div className="flex flex-col gap-4 pt-1 md:max-w-70">
